...
var G__22374 = o;
reagent.impl.template.goog$module$goog$object.set(G__22374,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
var G__22376 = o;
reagent.impl.template.goog$module$goog$object.set(G__22376,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__22378 = props;
var G__22378__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22378,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22378);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22378__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22379 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22379,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22379;
}
})(),id_class);
...
var G__22380 = (cljs.core.count(argv) - first_child);
switch (G__22380) {
case (0):
...
var vec__22381 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22381,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22381,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22381,(2),null);
...
var temp__5829__auto___22506 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22506 == null)){
} else {
var key_22507 = temp__5829__auto___22506;
(jsprops.key = key_22507);
}
...
var temp__5829__auto___22508 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22508 == null)){
} else {
var key_22509 = temp__5829__auto___22508;
...
var temp__5829__auto___22510 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22510 == null)){
} else {
var key_22511 = temp__5829__auto___22510;
(jsprops.key = key_22511);
}
...
var temp__5829__auto___22544 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22544 == null)){
} else {
var key_22545 = temp__5829__auto___22544;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22462_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22462_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22469 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22469,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22469,(1),null);
