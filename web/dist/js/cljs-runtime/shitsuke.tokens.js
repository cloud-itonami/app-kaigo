...
var i__5727__auto___21947 = (0);
while(true){
if((i__5727__auto___21947 < len__5726__auto___21946)){
args__5732__auto__.push((arguments[i__5727__auto___21947]));

var G__21948 = (i__5727__auto___21947 + (1));
i__5727__auto___21947 = G__21948;
continue;
} else {
}
break;
...
/** @this {Function} */
(shitsuke.tokens.deep_merge.cljs$lang$applyTo = (function (seq21889){
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$pair__GT_css_$_iter__21890(s__21891){
return (new cljs.core.LazySeq(null,(function (){
var s__21891__$1 = s__21891;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__21891__$1);
if(temp__5825__auto__){
var s__21891__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21891__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__21891__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__21893 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__21892 = (0);
while(true){
if((i__21892 < size__5479__auto__)){
var vec__21907 = cljs.core._nth(c__5478__auto__,i__21892);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21907,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21907,(1),null);
cljs.core.chunk_append(b__21893,["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__21958 = (i__21892 + (1));
i__21892 = G__21958;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21893),shitsuke$tokens$pair__GT_css_$_iter__21890(cljs.core.chunk_rest(s__21891__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21893),null);
}
} else {
var vec__21910 = cljs.core.first(s__21891__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21910,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21910,(1),null);
return cljs.core.cons(["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$tokens$pair__GT_css_$_iter__21890(cljs.core.rest(s__21891__$2)));
}
} else {
return null;
}
...
var body = clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$iter__21915(s__21916){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__21921 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21921,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21921,(1),null);
var iterys__5476__auto__ = ((function (s__21916__$1,vec__21921,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function shitsuke$tokens$iter__21915_$_iter__21917(s__21918){
return (new cljs.core.LazySeq(null,((function (s__21916__$1,vec__21921,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function (){
var s__21918__$1 = s__21918;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__21918__$1);
if(temp__5825__auto____$1){
var s__21918__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__21918__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__21918__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__21920 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__21919 = (0);
while(true){
if((i__21919 < size__5479__auto__)){
var vec__21924 = cljs.core._nth(c__5478__auto__,i__21919);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21924,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21924,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__21920,shitsuke.tokens.pair__GT_css(group,k,v));

var G__21975 = (i__21919 + (1));
i__21919 = G__21975;
continue;
} else {
var G__21977 = (i__21919 + (1));
i__21919 = G__21977;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21920),shitsuke$tokens$iter__21915_$_iter__21917(cljs.core.chunk_rest(s__21918__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21920),null);
}
} else {
var vec__21927 = cljs.core.first(s__21918__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.tokens.pair__GT_css(group,k,v),shitsuke$tokens$iter__21915_$_iter__21917(cljs.core.rest(s__21918__$2)));
} else {
var G__21981 = cljs.core.rest(s__21918__$2);
s__21918__$1 = G__21981;
continue;
}
}
} else {
...
});})(s__21916__$1,vec__21921,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
,null,null));
});})(s__21916__$1,vec__21921,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,shitsuke$tokens$iter__21915(cljs.core.rest(s__21916__$1)));
} else {
var G__21991 = cljs.core.rest(s__21916__$1);
s__21916__$1 = G__21991;
continue;
}
} else {
return null;
...
var map__21930 = deck_design;
var map__21930__$1 = cljs.core.__destructure_map(map__21930);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21930__$1,new cljs.core.Keyword("slides","theme","slides/theme",-79736158));
var text_styles = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21930__$1,new cljs.core.Keyword("slides","text-styles","slides/text-styles",-2082623934));
...
var color_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__21931){
...
var type_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__21935){
var vec__21936 = p__21935;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21936,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21936,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,(function (){var G__21939 = cljs.core.PersistentArrayMap.EMPTY;
var G__21939__$1 = (cljs.core.truth_(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21939,new cljs.core.Keyword(null,"font-size","font-size",-1847940346),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts)),"px"].join('')):G__21939);
var G__21939__$2 = (cljs.core.truth_(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21939__$1,new cljs.core.Keyword(null,"color","color",1011675173),shitsuke.tokens.normalize_hex(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))):G__21939__$1);
if(cljs.core.truth_(new cljs.core.Keyword("slides","bold","slides/bold",-1297473049).cljs$core$IFn$_invoke$arity$1(ts))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21939__$2,new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(700));
} else {
return G__21939__$2;
}
})()], null);
})),text_styles);
var font_family = (function (){var or__5002__auto__ = (function (){var G__21940 = new cljs.core.Keyword("office-style.font","majorFont","office-style.font/majorFont",1886256746).cljs$core$IFn$_invoke$arity$1(fonts);
if((G__21940 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21940),", system-ui, sans-serif"].join('');
}
})();
...
var G__21941 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("shitsuke","colors","shitsuke/colors",-494612392),color_tokens], null);
if(cljs.core.seq(type_tokens)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21941,new cljs.core.Keyword("shitsuke","type","shitsuke/type",1602529816),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__21942){
var vec__21943 = p__21942;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21943,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21943,(1),null);
