...
var h__$1 = (function (){var G__22560 = h;
if(clojure.string.starts_with_QMARK_(h,"#")){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$2(G__22560,(1));
} else {
return G__22560;
}
})();
 ...
 */
byoubu.color.rgb__GT_hex = (function byoubu$color$rgb__GT_hex(p__22561){
var vec__22562 = p__22561;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22562,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22562,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22562,(2),null);
...
var vec__22565 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22565,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22565,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22565,(2),null);
...
var pairs = cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__22568){
var vec__22569 = p__22568;
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22569,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22569,(1),null);
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
...
if((total > (0))){
return byoubu.color.rgb__GT_hex((function (){var iter__5480__auto__ = (function byoubu$color$mix_$_iter__22572(s__22573){
return (new cljs.core.LazySeq(null,(function (){
var s__22573__$1 = s__22573;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22573__$1);
if(temp__5825__auto__){
var s__22573__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22573__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22573__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22575 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22574 = (0);
while(true){
if((i__22574 < size__5479__auto__)){
var i = cljs.core._nth(c__5478__auto__,i__22574);
cljs.core.chunk_append(b__22575,(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,0.0,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i__22574,i,c__5478__auto__,size__5479__auto__,b__22575,s__22573__$2,temp__5825__auto__,pairs,total){
return (function (p__22582){
var vec__22583 = p__22582;
var rgb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22583,(0),null);
...
});})(i__22574,i,c__5478__auto__,size__5479__auto__,b__22575,s__22573__$2,temp__5825__auto__,pairs,total))
,pairs)) / total));

var G__22664 = (i__22574 + (1));
i__22574 = G__22664;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22575),byoubu$color$mix_$_iter__22572(cljs.core.chunk_rest(s__22573__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22575),null);
}
} else {
var i = cljs.core.first(s__22573__$2);
return cljs.core.cons((cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,0.0,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i,s__22573__$2,temp__5825__auto__,pairs,total){
return (function (p__22586){
var vec__22587 = p__22586;
var rgb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22587,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22587,(1),null);
return (w * cljs.core.nth.cljs$core$IFn$_invoke$arity$2(rgb,i));
});})(i,s__22573__$2,temp__5825__auto__,pairs,total))
,pairs)) / total),byoubu$color$mix_$_iter__22572(cljs.core.rest(s__22573__$2)));
}
} else {
return null;
}
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22621 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22621,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22621,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22621,(2),null);
var r__$1 = (r / 255.0);
var g__$1 = (g / 255.0);
var b__$1 = (b / 255.0);
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22651 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22651,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22651,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22651,(2),null);
var r__$1 = (r / 255.0);
var g__$1 = (g / 255.0);
var b__$1 = (b / 255.0);
var mx = (function (){var x__5087__auto__ = (function (){var x__5087__auto__ = r__$1;
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22654 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22654,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22654,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22654,(2),null);
