...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",(function (){var iter__5480__auto__ = (function byoubu_ui$style$stops_str_$_iter__23126(s__23127){
...
var map__23130 = cljs.core._nth(c__5478__auto__,i__23128);
var map__23130__$1 = cljs.core.__destructure_map(map__23130);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23130__$1,new cljs.core.Keyword("plate","color","plate/color",914427071));
var at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23130__$1,new cljs.core.Keyword("plate","at","plate/at",1101651535));
cljs.core.chunk_append(b__23129,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(color)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(at)].join(''));

var G__23187 = (i__23128 + (1));
i__23128 = G__23187;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23129),byoubu_ui$style$stops_str_$_iter__23126(cljs.core.chunk_rest(s__23127__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23129),null);
}
} else {
var map__23131 = cljs.core.first(s__23127__$2);
var map__23131__$1 = cljs.core.__destructure_map(map__23131);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23131__$1,new cljs.core.Keyword("plate","color","plate/color",914427071));
var at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23131__$1,new cljs.core.Keyword("plate","at","plate/at",1101651535));
return cljs.core.cons([cljs.core.str.cljs$core$IFn$_invoke$arity$1(color)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(at)].join(''),byoubu_ui$style$stops_str_$_iter__23126(cljs.core.rest(s__23127__$2)));
}
} else {
return null;
}
 ...
 */
byoubu_ui.style.layer_str = (function byoubu_ui$style$layer_str(p__23132){
var map__23133 = p__23132;
var map__23133__$1 = cljs.core.__destructure_map(map__23133);
var kind = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23133__$1,new cljs.core.Keyword("plate","kind","plate/kind",-1424213105));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23133__$1,new cljs.core.Keyword("plate","direction","plate/direction",-651904309));
var shape = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23133__$1,new cljs.core.Keyword("plate","shape","plate/shape",1889905040));
var stops = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23133__$1,new cljs.core.Keyword("plate","stops","plate/stops",-1312702775));
var G__23134 = kind;
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var iter__5480__auto__ = (function byoubu_ui$style$component_css_$_iter__23135(s__23136){
return (new cljs.core.LazySeq(null,(function (){
var s__23136__$1 = s__23136;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23136__$1);
if(temp__5825__auto__){
var s__23136__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23136__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23136__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23138 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23137 = (0);
while(true){
if((i__23137 < size__5479__auto__)){
var vec__23139 = cljs.core._nth(c__5478__auto__,i__23137);
var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23139,(0),null);
var decls = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23139,(1),null);
cljs.core.chunk_append(b__23138,css.core.rule(sel,decls));

var G__23196 = (i__23137 + (1));
i__23137 = G__23196;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23138),byoubu_ui$style$component_css_$_iter__23135(cljs.core.chunk_rest(s__23136__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23138),null);
}
} else {
var vec__23142 = cljs.core.first(s__23136__$2);
var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23142,(0),null);
var decls = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23142,(1),null);
return cljs.core.cons(css.core.rule(sel,decls),byoubu_ui$style$component_css_$_iter__23135(cljs.core.rest(s__23136__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__5480__auto__ = (function byoubu_ui$style$component_css_$_iter__23145(s__23146){
return (new cljs.core.LazySeq(null,(function (){
var s__23146__$1 = s__23146;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23146__$1);
if(temp__5825__auto__){
var s__23146__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23146__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23146__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23148 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23147 = (0);
while(true){
if((i__23147 < size__5479__auto__)){
var vec__23156 = cljs.core._nth(c__5478__auto__,i__23147);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23156,(0),null);
var rules = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23156,(1),null);
cljs.core.chunk_append(b__23148,css.core.media(q,rules));

var G__23198 = (i__23147 + (1));
i__23147 = G__23198;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23148),byoubu_ui$style$component_css_$_iter__23145(cljs.core.chunk_rest(s__23146__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23148),null);
}
} else {
var vec__23181 = cljs.core.first(s__23146__$2);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23181,(0),null);
var rules = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23181,(1),null);
return cljs.core.cons(css.core.media(q,rules),byoubu_ui$style$component_css_$_iter__23145(cljs.core.rest(s__23146__$2)));
}
} else {
return null;
}
