...
return byoubu.color.mix((function (){var iter__5480__auto__ = (function byoubu$facts$declared_content_color_$_iter__22657(s__22658){
...
var vec__22661 = cljs.core._nth(c__5478__auto__,i__22659);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22661,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22661,(1),null);
cljs.core.chunk_append(b__22660,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null));

var G__22825 = (i__22659 + (1));
i__22659 = G__22825;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22660),byoubu$facts$declared_content_color_$_iter__22657(cljs.core.chunk_rest(s__22658__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22660),null);
}
} else {
var vec__22665 = cljs.core.first(s__22658__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22665,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22665,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null),byoubu$facts$declared_content_color_$_iter__22657(cljs.core.rest(s__22658__$2)));
}
} else {
return null;
}
...
var G__22668 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"declared","declared",92336021),byoubu.facts.declared_content_color(backdrop)], null);
var G__22668__$1 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22668,new cljs.core.Keyword(null,"plate","plate",-1920178141),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null))):G__22668);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22668__$1,new cljs.core.Keyword(null,"poster","poster",-1616913550),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"poster","poster",-1616913550),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)));
} else {
return G__22668__$1;
}
});
...
return cljs.core.first(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p__22750){
var vec__22751 = p__22750;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22751,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22751,(1),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22751,(2),null);
return (- r);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__22754){
var vec__22755 = p__22754;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22755,(0),null);
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22755,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,hex,cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22749_SHARP_){
var or__5002__auto__ = byoubu.color.contrast_ratio(hex,p1__22749_SHARP_);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return 0.0;
...
var vec__22758 = byoubu.facts.best_ink(cljs.core.vals(tiers));
var ink_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22758,(0),null);
var ink = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22758,(1),null);
var ratio = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22758,(2),null);
...
var c__5478__auto__ = cljs.core.chunk_first(s__22762__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22764 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22763 = (0);
while(true){
if((i__22763 < size__5479__auto__)){
var vec__22808 = cljs.core._nth(c__5478__auto__,i__22763);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22808,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22808,(1),null);
cljs.core.chunk_append(b__22764,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t,byoubu.color.contrast_ratio(ink,c)], null));

var G__22826 = (i__22763 + (1));
i__22763 = G__22826;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22764),byoubu$facts$derive_facts_$_iter__22761(cljs.core.chunk_rest(s__22762__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22764),null);
}
} else {
var vec__22811 = cljs.core.first(s__22762__$2);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22811,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22811,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t,byoubu.color.contrast_ratio(ink,c)], null),byoubu$facts$derive_facts_$_iter__22761(cljs.core.rest(s__22762__$2)));
}
} else {
return null;
}
