...
return G__22257__$1.reagentRender;
}
})() == null)))));
});
...
return (function() { 
var G__22452__delegate = function (args){
...
return G__22452__delegate.call(this,args);};
G__22452.cljs$lang$maxFixedArity = 0;
G__22452.cljs$lang$applyTo = (function (arglist__22463){
var args = cljs.core.seq(arglist__22463);
return G__22452__delegate(args);
});
...
var or__5002__auto__ = (function (){var G__22260 = c;
var G__22260__$1 = (((G__22260 == null))?null:G__22260.constructor);
...
var G__22261 = c;
var G__22261__$1 = (((G__22261 == null))?null:G__22261.constructor);
if((G__22261__$1 == null)){
return null;
} else {
return G__22261__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__22262 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22263 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22263);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22262);
}});
...
var c = this;
var G__22266_22478 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__22266_22478 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22266_22478);
}
...
var renders_22487 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22488 = cljs.core.first(cljs.core.vals(renders_22487));
...
if((cljs.core.count(renders_22487) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22487))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22488)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22488], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__22270 = o;
reagent.impl.component.goog$module$goog$object.set(G__22270,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__22335 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22336 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22336);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22335);
}});
...
var vec__22337 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22337,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22337,(1),null);
...
var G__22353 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__22353 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22353);
}
});
}),[]);
