...
(liquid_glass.tokens.spring_linear_easing.cljs$core$IFn$_invoke$arity$1 = (function (p__22020){
var map__22022 = p__22020;
var map__22022__$1 = cljs.core.__destructure_map(map__22022);
var zeta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22022__$1,new cljs.core.Keyword(null,"zeta","zeta",257464678),0.55);
var omega = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22022__$1,new cljs.core.Keyword(null,"omega","omega",277265652),13.0);
var samples = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22022__$1,new cljs.core.Keyword(null,"samples","samples",635504833),(16));
...
return ["linear(",clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$iter__22051(s__22052){
return (new cljs.core.LazySeq(null,(function (){
var s__22052__$1 = s__22052;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22052__$1);
if(temp__5825__auto__){
var s__22052__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22052__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22052__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22054 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22053 = (0);
while(true){
if((i__22053 < size__5479__auto__)){
var i = cljs.core._nth(c__5478__auto__,i__22053);
cljs.core.chunk_append(b__22054,fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))));

var G__22117 = (i__22053 + (1));
i__22053 = G__22117;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22054),liquid_glass$tokens$iter__22051(cljs.core.chunk_rest(s__22052__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22054),null);
}
} else {
var i = cljs.core.first(s__22052__$2);
return cljs.core.cons(fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))),liquid_glass$tokens$iter__22051(cljs.core.rest(s__22052__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$pair__GT_css_$_iter__22060(s__22061){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__22064 = cljs.core._nth(c__5478__auto__,i__22062);
...
cljs.core.chunk_append(b__22063,["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__22124 = (i__22062 + (1));
i__22062 = G__22124;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22063),liquid_glass$tokens$pair__GT_css_$_iter__22060(cljs.core.chunk_rest(s__22061__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22063),null);
}
} else {
var vec__22072 = cljs.core.first(s__22061__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22072,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22072,(1),null);
return cljs.core.cons(["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),liquid_glass$tokens$pair__GT_css_$_iter__22060(cljs.core.rest(s__22061__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$tokens__GT_body_$_iter__22076(s__22077){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__22090 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22090,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22090,(1),null);
var iterys__5476__auto__ = ((function (s__22077__$1,vec__22090,group,m,xs__6385__auto__,temp__5825__auto__){
return (function liquid_glass$tokens$tokens__GT_body_$_iter__22076_$_iter__22078(s__22079){
return (new cljs.core.LazySeq(null,((function (s__22077__$1,vec__22090,group,m,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__22079__$1 = s__22079;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22079__$1);
if(temp__5825__auto____$1){
var s__22079__$2 = temp__5825__auto____$1;
...
var vec__22094 = cljs.core._nth(c__5478__auto__,i__22080);
...
if((!((v == null)))){
cljs.core.chunk_append(b__22081,liquid_glass.tokens.pair__GT_css(group,k,v));

var G__22152 = (i__22080 + (1));
i__22080 = G__22152;
continue;
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22081),liquid_glass$tokens$tokens__GT_body_$_iter__22076_$_iter__22078(cljs.core.chunk_rest(s__22079__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22081),null);
}
} else {
var vec__22097 = cljs.core.first(s__22079__$2);
...
if((!((v == null)))){
return cljs.core.cons(liquid_glass.tokens.pair__GT_css(group,k,v),liquid_glass$tokens$tokens__GT_body_$_iter__22076_$_iter__22078(cljs.core.rest(s__22079__$2)));
} else {
var G__22154 = cljs.core.rest(s__22079__$2);
s__22079__$1 = G__22154;
continue;
}
}
} else {
...
});})(s__22077__$1,vec__22090,group,m,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__22077__$1,vec__22090,group,m,xs__6385__auto__,temp__5825__auto__))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,liquid_glass$tokens$tokens__GT_body_$_iter__22076(cljs.core.rest(s__22077__$1)));
} else {
var G__22155 = cljs.core.rest(s__22077__$1);
s__22077__$1 = G__22155;
continue;
}
} else {
return null;
