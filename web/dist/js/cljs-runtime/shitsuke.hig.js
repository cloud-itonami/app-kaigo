...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22931){
 ...
 */
shitsuke.hig.default_hig_tokens = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword("hig","font","hig/font",-1506004751),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"text","text",-1790561697),shitsuke.hig.font_family_text,new cljs.core.Keyword(null,"display","display",242065432),shitsuke.hig.font_family_display,new cljs.core.Keyword(null,"mono","mono",-1777958350),shitsuke.hig.font_family_mono], null),new cljs.core.Keyword("hig","text","hig/text",-1790736923),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22935){
var vec__22985 = p__22935;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22985,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22985,(1),null);
...
})),shitsuke.hig.text_styles),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22988){
var vec__22989 = p__22988;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22989,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22989,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$pair__GT_css_$_iter__23065(s__23066){
return (new cljs.core.LazySeq(null,(function (){
var s__23066__$1 = s__23066;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23066__$1);
if(temp__5825__auto__){
var s__23066__$2 = temp__5825__auto__;
...
var vec__23070 = cljs.core._nth(c__5478__auto__,i__23067);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23070,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23070,(1),null);
cljs.core.chunk_append(b__23068,["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__23336 = (i__23067 + (1));
i__23067 = G__23336;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23068),shitsuke$hig$pair__GT_css_$_iter__23065(cljs.core.chunk_rest(s__23066__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23068),null);
}
} else {
var vec__23073 = cljs.core.first(s__23066__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23073,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23073,(1),null);
return cljs.core.cons(["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$hig$pair__GT_css_$_iter__23065(cljs.core.rest(s__23066__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$tokens__GT_css_lines_$_iter__23087(s__23088){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__23091 = cljs.core._nth(c__5478__auto__,i__23089);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23091,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23091,(1),null);
if((!((m == null)))){
cljs.core.chunk_append(b__23090,((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (i__23089,s__23088__$1,vec__23091,group,m,c__5478__auto__,size__5479__auto__,b__23090,s__23088__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__23087_$_iter__23094(s__23095){
return (new cljs.core.LazySeq(null,((function (i__23089,s__23088__$1,vec__23091,group,m,c__5478__auto__,size__5479__auto__,b__23090,s__23088__$2,temp__5825__auto__){
return (function (){
var s__23095__$1 = s__23095;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__23095__$1);
if(temp__5825__auto____$1){
var s__23095__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__23095__$2)){
var c__5478__auto____$1 = cljs.core.chunk_first(s__23095__$2);
var size__5479__auto____$1 = cljs.core.count(c__5478__auto____$1);
var b__23097 = cljs.core.chunk_buffer(size__5479__auto____$1);
if((function (){var i__23096 = (0);
while(true){
if((i__23096 < size__5479__auto____$1)){
var vec__23149 = cljs.core._nth(c__5478__auto____$1,i__23096);
...
if((!((v == null)))){
cljs.core.chunk_append(b__23097,shitsuke.hig.pair__GT_css(group,k,v));

var G__23337 = (i__23096 + (1));
i__23096 = G__23337;
continue;
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23097),shitsuke$hig$tokens__GT_css_lines_$_iter__23087_$_iter__23094(cljs.core.chunk_rest(s__23095__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23097),null);
}
} else {
var vec__23152 = cljs.core.first(s__23095__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23152,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23152,(1),null);
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__23087_$_iter__23094(cljs.core.rest(s__23095__$2)));
} else {
var G__23339 = cljs.core.rest(s__23095__$2);
s__23095__$1 = G__23339;
continue;
}
}
} else {
...
});})(i__23089,s__23088__$1,vec__23091,group,m,c__5478__auto__,size__5479__auto__,b__23090,s__23088__$2,temp__5825__auto__))
,null,null));
});})(i__23089,s__23088__$1,vec__23091,group,m,c__5478__auto__,size__5479__auto__,b__23090,s__23088__$2,temp__5825__auto__))
;
...
var G__23340 = (i__23089 + (1));
i__23089 = G__23340;
continue;
} else {
var G__23341 = (i__23089 + (1));
i__23089 = G__23341;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23090),shitsuke$hig$tokens__GT_css_lines_$_iter__23087(cljs.core.chunk_rest(s__23088__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23090),null);
}
} else {
var vec__23159 = cljs.core.first(s__23088__$2);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23159,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23159,(1),null);
if((!((m == null)))){
return cljs.core.cons(((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (s__23088__$1,vec__23159,group,m,s__23088__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__23087_$_iter__23162(s__23163){
return (new cljs.core.LazySeq(null,((function (s__23088__$1,vec__23159,group,m,s__23088__$2,temp__5825__auto__){
return (function (){
var s__23163__$1 = s__23163;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__23163__$1);
if(temp__5825__auto____$1){
var s__23163__$2 = temp__5825__auto____$1;
...
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23166,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23166,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__23165,shitsuke.hig.pair__GT_css(group,k,v));

var G__23342 = (i__23164 + (1));
i__23164 = G__23342;
continue;
} else {
var G__23343 = (i__23164 + (1));
i__23164 = G__23343;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23165),shitsuke$hig$tokens__GT_css_lines_$_iter__23087_$_iter__23162(cljs.core.chunk_rest(s__23163__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23165),null);
}
} else {
var vec__23171 = cljs.core.first(s__23163__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__23087_$_iter__23162(cljs.core.rest(s__23163__$2)));
} else {
var G__23344 = cljs.core.rest(s__23163__$2);
s__23163__$1 = G__23344;
continue;
}
}
} else {
...
});})(s__23088__$1,vec__23159,group,m,s__23088__$2,temp__5825__auto__))
,null,null));
});})(s__23088__$1,vec__23159,group,m,s__23088__$2,temp__5825__auto__))
;
return iter__5480__auto__(m);
})()):["  --hig-",cljs.core.name(group),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(m),";"].join('')),shitsuke$hig$tokens__GT_css_lines_$_iter__23087(cljs.core.rest(s__23088__$2)));
} else {
var G__23345 = cljs.core.rest(s__23088__$2);
s__23088__$1 = G__23345;
continue;
}
}
} else {
 ...
 *   `@layer kotoba.hig`.
 */
shitsuke.hig.text_style_classes = ["@layer kotoba.hig {\n",clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$iter__23211(s__23212){
return (new cljs.core.LazySeq(null,(function (){
var s__23212__$1 = s__23212;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23212__$1);
if(temp__5825__auto__){
var s__23212__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23212__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23212__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23214 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23213 = (0);
while(true){
if((i__23213 < size__5479__auto__)){
var style = cljs.core._nth(c__5478__auto__,i__23213);
cljs.core.chunk_append(b__23214,[".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''));

var G__23350 = (i__23213 + (1));
i__23213 = G__23350;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23214),shitsuke$hig$iter__23211(cljs.core.chunk_rest(s__23212__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23214),null);
}
} else {
var style = cljs.core.first(s__23212__$2);
return cljs.core.cons([".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''),shitsuke$hig$iter__23211(cljs.core.rest(s__23212__$2)));
}
} else {
return null;
}
